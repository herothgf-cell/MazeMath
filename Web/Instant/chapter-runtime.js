...
'chapter-05':[
 ['c5.number',18,0,'별빛 숫자 엔진을 풀어 첫 문을 열어요'],
 ['c5.equipment',34,0,'표시된 장비를 골라 장비 게이트를 통과해요'],
 ['c5.spatial',50,8,'상자와 발판을 이용해 공간 퍼즐을 풀어요'],
 ['c5.memory',26,16,'별빛 경로를 기억해 같은 순서로 이동해요'],
 ['boss.number',42,24,'최종 골렘의 숫자 엔진을 풀어요'],
 ['boss.equipment',48,24,'지정된 장비로 장비 보호막을 해제해요'],
 ['boss.spatial',54,24,'공간 퍼즐 보호막을 해제해요'],
 ['boss.memory',60,24,'기억 퍼즐 보호막을 해제해요'],
 ['boss.core',66,24,'별빛 코어를 조사해 마지막 보호막을 해제해요'],
 ['finish',69,24,'별빛 코어 골렘에게 마지막으로 조사해요']
]};
